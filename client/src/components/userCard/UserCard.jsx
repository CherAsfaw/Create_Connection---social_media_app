...
const UserCard = ({user}) => {
  ...
  return (
    <div
      key={user._id}
      className="p-4 pt-6 flex flex-col justify-between w-72 border border-gray-200 shadow rounded-md"
    >
      <div className="text-center">
        <img
          src={user.profile_picture}
          alt=""
          className="w-16 rounded-full shadow-md mx-auto"
        />
        ...
        {user.bio && (
          <p className="text-gray-600 mt-4 px-4 text-center text-sm">
            {user.bio}
          </p>
        )}
      </div>
      {/* location and No of follower */}
      ...
      <div className="flex mt-4 gap-2">
        ...
        {/* connection request button add button/message button */}
        <button
