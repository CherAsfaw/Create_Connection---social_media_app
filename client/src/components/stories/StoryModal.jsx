...
const StoryModal = ({setShowModal, getStories}) => {
  const bgColor = ['#4f46e5', '#7c3ead', '#db2777', '#e11d48', '#ca8a04', '#0d9488'];
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex mt-4 gap-2">
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 p-2 cursor-pointer
