...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      className={`w-60 xl:w-72 h-full bg-white border-r border-gray-200 flex flex-col
    ...
    >
      <div className="w-full">
        ...
        bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 to-purple-800 active:scale-95
