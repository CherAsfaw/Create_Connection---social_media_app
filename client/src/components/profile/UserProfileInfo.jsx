  ...
  return (
    <div className="relative py-4 px-6 md:px8 bg-white">
      <div className="flex flex-col md:flex-row gap-6 items-start">
        {/* profile image */}
        <div className="w-32 h-32 border border-white shadow-lg absolute -top-16 rounded-full">
          <img
        ...
        {/* user info */}
        <div className="w-full pt-16 md:py-0 md:pl-36">
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            {/* if user is not other profile tha means he is opening  his profile so we give edit button*/}
            {!profileId && (
              <button
          ...
          {/* user bio */}
          <p className="text-gray-700 text-sm w-max-w-md mt-4">{user?.bio||'Add Bio'}</p>
          {/* user location */}
